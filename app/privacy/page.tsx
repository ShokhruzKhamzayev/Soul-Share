        ...
        <div className="custom-container py-[20px] flex justify-between flex-col lg:flex-row gap-[30px] lg:gap-0">
            <section className="w-full lg:w-[47%] text-center">
                ...
                <p className="italic tracking-wider">
                    Just text your <Link href={'/cardSender'} className="text-blue-600">message</Link> and press send. After the administrators will approve your message it will appear on the website’s main page.
                </p>
