...
export default function PrivacyPage() {
    return (
        <div className="custom-container min-h-[80vh] flex justify-center items-center">
            <div className="flex justify-between flex-col lg:flex-row gap-[30px] lg:gap-0">
                <section className="w-full lg:w-[47%] text-center">
                    <h1 className="text-[30px] md:text-3xl lg:text-5xl text-[#2F4DE4] text-balance mb-[20px] font-bold dark:text-yellow-200">
                    ...
                    <p className="italic tracking-wider">
                        Just text your <Link href={'/card'} className="text-blue-600 dark:text-yellow-200">message</Link> and press send. After the administrators will approve your message it will appear on the website’s main page.
                    </p>
